...
OBJECTS_DEFINITIONS = {
    ...
    field_height = { -- Height of the field, can be any positive integer
        ...
        default = {
            Field = {
                min = OBJECTS_DEFINITIONS.field_height_min.enum.Field,
                max = OBJECTS_DEFINITIONS.field_height_max.enum.Field,
                initial = OBJECTS_DEFINITIONS.field_height.enum.Field,
                edited = nil
            },
            Literal = {
                min = OBJECTS_DEFINITIONS.field_height_min.enum.Literal,
                max = OBJECTS_DEFINITIONS.field_height_max.enum.Literal,
                initial = OBJECTS_DEFINITIONS.field_height.enum.Literal,
                edited = nil
            },
            ProtectedLiteral = {
                min = OBJECTS_DEFINITIONS.field_height_min.enum.ProtectedLiteral,
                max = OBJECTS_DEFINITIONS.field_height_max.enum.ProtectedLiteral,
                initial = OBJECTS_DEFINITIONS.field_height.enum.ProtectedLiteral,
                edited = nil
            },
            BooleanField = {
                min = OBJECTS_DEFINITIONS.field_height_min.enum.BooleanField,
                max = OBJECTS_DEFINITIONS.field_height_max.enum.BooleanField,
                initial = OBJECTS_DEFINITIONS.field_height.enum.BooleanField,
                edited = nil
            },
            Image = {
                min = OBJECTS_DEFINITIONS.field_height_min.enum.Image,
                max = OBJECTS_DEFINITIONS.field_height_max.enum.Image,
                initial = OBJECTS_DEFINITIONS.field_height.enum.Image,
                edited = nil
            },
            Line = {
                min = OBJECTS_DEFINITIONS.field_height_min.enum.Line,
                max = OBJECTS_DEFINITIONS.field_height_max.enum.Line,
                initial = OBJECTS_DEFINITIONS.field_height.enum.Line,
                edited = nil
            },
            Fieldset = {
                min = OBJECTS_DEFINITIONS.field_height_min.enum.Fieldset,
                max = OBJECTS_DEFINITIONS.field_height_max.enum.Fieldset,
    ...
    field_footer_color = {
        ...
        default = {
            Field = {
                default = OBJECTS_DEFINITIONS.field_footer_color.enum.default,
                white = OBJECTS_DEFINITIONS.field_footer_color.enum.white,
                green = OBJECTS_DEFINITIONS.field_footer_color.enum.green,
                yellow = OBJECTS_DEFINITIONS.field_footer_color.enum.yellow,
                blue = OBJECTS_DEFINITIONS.field_footer_color.enum.blue,
                cyan = OBJECTS_DEFINITIONS.field_footer_color.enum.cyan
            },
            Literal = {
                default = OBJECTS_DEFINITIONS.field_footer_color.enum.default,
                white = OBJECTS_DEFINITIONS.field_footer_color.enum.white,
    ...
    field_text_align = {
        ...
        default = {
            Field = {
                left = OBJECTS_DEFINITIONS.field_text_align.enum.left,
                center = OBJECTS_DEFINITIONS.field_text_align.enum.center,
                right = OBJECTS_DEFINITIONS.field_text_align.enum.right
            },
            Literal = {
                left = OBJECTS_DEFINITIONS.field_text_align.enum.left,
                center = OBJECTS_DEFINITIONS.field_text_align.enum.center,
    ...
    field_pos = { -- Represents the position of the field in the BMS screen (row, col)
        ...
        default = {
            Field = {
                col = OBJECTS_DEFINITIONS.field_pos.enum.zero,
                row = OBJECTS_DEFINITIONS.field_pos.enum.zero,
                rowend = OBJECTS_DEFINITIONS.field_pos.enum.zero,
                colend = OBJECTS_DEFINITIONS.field_pos.enum.zero
            },
            Literal = {
                col = OBJECTS_DEFINITIONS.field_pos.enum.zero,
                row = OBJECTS_DEFINITIONS.field_pos.enum.zero,
    ...
    field_border_style = {
        enum = OBJECTS_DEFINITIONS.field_avail_border_style.enum, -- Reference to available border styles
        default = {
    ...
    field_title_fill_char = {
        ...
        default = {
            Field = OBJECTS_DEFINITIONS.field_title_fill_char.enum.space,
            Literal = OBJECTS_DEFINITIONS.field_title_fill_char.enum.space,
            ProtectedLiteral = OBJECTS_DEFINITIONS.field_title_fill_char.enum.space,
            BooleanField = OBJECTS_DEFINITIONS.field_title_fill_char.enum.space,
            Image = OBJECTS_DEFINITIONS.field_title_fill_char.enum.dash,
            Line = OBJECTS_DEFINITIONS.field_title_fill_char.enum.dash,
            Fieldset = OBJECTS_DEFINITIONS.field_title_fill_char.enum.dash
        },
        initial = nil,
        edited = nil
    },
    ...
    field_fill_char = {
        ...
        default = {
            Field = OBJECTS_DEFINITIONS.field_fill_char.enum.underscore,
            Literal = OBJECTS_DEFINITIONS.field_fill_char.enum.space,
            ProtectedLiteral = OBJECTS_DEFINITIONS.field_fill_char.enum.space,
            BooleanField = OBJECTS_DEFINITIONS.field_fill_char.enum.space,
            Image = OBJECTS_DEFINITIONS.field_fill_char.enum.space,
            Line = OBJECTS_DEFINITIONS.field_fill_char.enum.dash,
            Fieldset = OBJECTS_DEFINITIONS.field_fill_char.enum.space
        },
        initial = nil,
        edited = nil
    },
