...
typedef OBJECTS_DEFINITIONS={
    field_name={-- Name of the object
        ...
        default={Field=self.enum.Field, Literal=self.enum.Literal, ProtectedLiteral=self.enum.ProtectedLiteral, BooleanField=self.enum.BooleanField, Image=self.enum.Image, Line=self.enum.Line, Fieldset=self.enum.Fieldset},-- Available field names
    ...
    field_type={-- Type of the field, can be Field, Literal, ProtectedLiteral, BooleanField, Image, Line, Fieldset
        ...
        default={Field=self.enum.Field, Literal=self.enum.Literal, ProtectedLiteral=self.enum.ProtectedLiteral, BooleanField=self.enum.BooleanField, Image=self.enum.Image, Line=self.enum.Line, Fieldset=self.enum.Fieldset},-- Available field types    
    ...
    field_min_height={-- Height of the field, can be any positive integer
        ...
        default={Field=self.enum.Field, Literal=self.enum.Literal, ProtectedLiteral=self.enum.ProtectedLiteral, BooleanField=self.enum.BooleanField, Image=self.enum.Image, Line=self.enum.Line, Fieldset=self.enum.Fieldset},--  Default height for each field type
    ...
    field_max_height={-- Maximum height of the field, can be any positive integer
        ...
        default={Field=self.enum.Field, Literal=self.enum.Literal, ProtectedLiteral=self.enum.ProtectedLiteral, BooleanField=self.enum.BooleanField, Image=self.enum.Image, Line=self.enum.Line, Fieldset=self.enum.Fieldset},--  Default max height for each field type
    ...
    field_width_max={-- Maximum length of the field, can be any positive integer
        ...
        default={Field=self.enum.Field, Literal=self.enum.Literal, ProtectedLiteral=self.enum.ProtectedLiteral, BooleanField=self.enum.BooleanField, Image=self.enum.Image, Line=self.enum.Line, Fieldset=self.enum.Fieldset},-- Default max length for each field type
    ...
    field_width_min={-- Minimum length of the field, can be any positive integer
        ...
        default={Field=self.enum.Field, Literal=self.enum.Literal, ProtectedLiteral=self.enum.ProtectedLiteral, BooleanField=self.enum.BooleanField, Image=self.enum.Image, Line=self.enum.Line, Fieldset=self.enum.Fieldset},-- Default min length for each field type
    ...
    field_width={-- Length of the field, can be any positive integer
        ...
        default={Field=self.enum.Field, Literal=self.enum.Literal, ProtectedLiteral=self.enum.ProtectedLiteral, BooleanField=self.enum.BooleanField, Image=self.enum.Image, Line=self.enum.Line, Fieldset=self.enum.Fieldset},-- Default length for each field type
    ...
    field_avail_color={
        ...
        default={
            ...
            Field={default=self.enum.default, white=self.enum.white, green=self.enum.green, yellow=self.enum.yellow, blue=self.enum.blue, cyan=self.enum.cyan},

            -- Literal : Texte statique (default = neutre, white/yellow = lisible, green = accent)
            Literal={default=self.enum.default, white=self.enum.white, yellow=self.enum.yellow, green=self.enum.green, cyan=self.enum.cyan, blue=self.enum.blue},

            -- ProtectedLiteral : Texte protege (white = par defaut pour read-only, green = protege, cyan = informatif)
            ProtectedLiteral={white=self.enum.white, green=self.enum.green, cyan=self.enum.cyan, yellow=self.enum.yellow, default=self.enum.default},

            -- BooleanField : Cases a cocher (default = neutre, green = coche/valide, white = non coche)
            BooleanField={default=self.enum.default, green=self.enum.green, white=self.enum.white, yellow=self.enum.yellow, blue=self.enum.blue},

            -- Image : Placeholder (default = transparent, white/blue = contour visible, cyan = water mark)
            Image={default=self.enum.default, white=self.enum.white, blue=self.enum.blue, cyan=self.enum.cyan},

            -- Line : Separateurs (default = invisible, white/blue/cyan = visibles mais discrets)
            Line={default=self.enum.default, white=self.enum.white, blue=self.enum.blue, cyan=self.enum.cyan},

            -- Fieldset : Conteneurs (blue = standard pour bordures, default = neutre, white/cyan = alternatifs)
            Fieldset={blue=self.enum.blue, default=self.enum.default, white=self.enum.white, cyan=self.enum.cyan, green=self.enum.green},
    ...
    field_border_color={
        enum=field_avail_color.enum,
        default={
            Field=field_avail_color.default.Field, 
            Literal=field_avail_color.default.Literal, 
            ProtectedLiteral=field_avail_color.default.ProtectedLiteral, 
            BooleanField=field_avail_color.default.BooleanField, 
            Image=field_avail_color.default.Image, 
            Line=field_avail_color.default.Line, 
            Fieldset=field_avail_color.default.Fieldset
    ...
    field_avail_font_family={
        ...
        default={
            ncurses={default=field_avail_font_family.enum.default}, -- ncurses: uses terminal's current single font
            tn3270={default=field_avail_font_family.enum.default}, -- 3270: IBM 3270 character set (single fixed-width font)
            bms={default=field_avail_font_family.enum.default} -- BMS: single fixed-width font (no selection available)
        },
        initial=field_avail_font_family.enum.default, -- Default font family for the initial field type
    },
    ...
    field_font_family={
        enum=field_avail_font_family.enum,
        default={
            -- All BMS field types reference the same single font (3270 has only one physical font)
            Field=field_avail_font_family.enum.default,
            Literal=field_avail_font_family.enum.default,
            ProtectedLiteral=field_avail_font_family.enum.default,
            BooleanField=field_avail_font_family.enum.default,
            Image=field_avail_font_family.enum.default,
            Line=field_avail_font_family.enum.default,
            Fieldset=field_avail_font_family.enum.default
    ...
    field_avail_style={
        ...
        default={
            ...
            Field={default=self.enum.default, bold=self.enum.bold, italic=self.enum.italic, underline=self.enum.underline, strikethrough=self.enum.strikethrough, blink=self.enum.blink, reverse=self.enum.reverse},

            -- Literal: Tous les styles (texte statique peut etre mis en valeur)
            Literal={default=self.enum.default, bold=self.enum.bold, italic=self.enum.italic, underline=self.enum.underline, blink=self.enum.blink, reverse=self.enum.reverse},

            -- ProtectedLiteral: Pas de italic/strikethrough/blink (distrayant pour read-only)
            ProtectedLiteral={default=self.enum.default, bold=self.enum.bold, underline=self.enum.underline, reverse=self.enum.reverse},

            -- BooleanField: Pas de italic/strikethrough; blink pour attention
            BooleanField={default=self.enum.default, bold=self.enum.bold, underline=self.enum.underline, blink=self.enum.blink, reverse=self.enum.reverse},

            -- Image: Pas de italic/strikethrough/blink (distrayant pour placeholder)
            Image={default=self.enum.default, bold=self.enum.bold, underline=self.enum.underline, reverse=self.enum.reverse},

            -- Line: underline pour effet tirete, strikethrough pour ligne brisee
            Line={underline=self.enum.underline, strikethrough=self.enum.strikethrough, default=self.enum.default, bold=self.enum.bold, reverse=self.enum.reverse},

            -- Fieldset: Tous les styles sauf strikethrough (peu pertinent pour bordures)
            Fieldset={default=self.enum.default, bold=self.enum.bold, underline=self.enum.underline, blink=self.enum.blink, reverse=self.enum.reverse}
    ...
    field_avail_text_align={
        ...
        default={
            Field={left=self.enum.left, center=self.enum.center, right=self.enum.right},
            Literal={left=self.enum.left, center=self.enum.center, right=self.enum.right},
            ProtectedLiteral={left=self.enum.left, center=self.enum.center, right=self.enum.right},
            BooleanField={left=self.enum.left, center=self.enum.center, right=self.enum.right},
            Image={left=self.enum.left, center=self.enum.center, right=self.enum.right},
            Line={left=self.enum.left, center=self.enum.center, right=self.enum.right},
            Fieldset={left=self.enum.left, center=self.enum.center, right=self.enum.right}, 
   ...
   -- field_text_align represents the text alignment for each field type, which can be left, center, or right
    field_text_align={
        enum=field_avail_text_align.enum,
        default= {
            Field=field_avail_text_align.default.Field,
            Literal=field_avail_text_align.default.Literal,
            ProtectedLiteral=field_avail_text_align.default.ProtectedLiteral,
            BooleanField=field_avail_text_align.default.BooleanField,
            Image=field_avail_text_align.default.Image,
            Line=field_avail_text_align.default.Line,
            Fieldset=field_avail_text_align.default.Fieldset,
    ...
    field_pos={ -- Represents the position of the field in the BMS screen (row, col)
        ...
        default={
            Field={col=self.enum.zero, row=self.enum.zero, rowend=self.enum.zero, colend=self.enum.zero},
            Literal={col=self.enum.zero, row=self.enum.zero, rowend=self.enum.zero, colend=self.enum.zero},
            ProtectedLiteral={col=self.enum.zero, row=self.enum.zero, rowend=self.enum.zero, colend=self.enum.zero},
            BooleanField={col=self.enum.zero, row=self.enum.zero, rowend=self.enum.zero, colend=self.enum.zero},
            Image={col=self.enum.zero, row=self.enum.zero, rowend=self.enum.zero, colend=self.enum.zero},
            Line={col=self.enum.zero, row=self.enum.zero, rowend=self.enum.zero, colend=self.enum.zero},
            Fieldset={col=self.enum.zero, row=self.enum.zero, rowend=self.enum.zero, colend=self.enum.zero}
    ...
    field_avail_border_style={ -- Available border styles for each field type: single, double, dashed, none
        ...
        default={
            ...
            Field={single=self.enum.single, double=self.enum.double, dashed=self.enum.dashed, none=self.enum.none},

            -- Literal : Pas de bordure par defaut (texte statique n'en a pas besoin)
            Literal={none=self.enum.none, single=self.enum.single, dashed=self.enum.dashed},

            -- ProtectedLiteral : Bordure pointillee pour indiquer protection
            ProtectedLiteral={dashed=self.enum.dashed, single=self.enum.single, double=self.enum.double, none=self.enum.none},

            -- BooleanField : Bordure simple pour cases a cocher
            BooleanField={single=self.enum.single, double=self.enum.double, dashed=self.enum.dashed},

            -- Image : Bordure double pour encadrer les placeholders
            Image={double=self.enum.double, single=self.enum.single, dashed=self.enum.dashed, none=self.enum.none},

            -- Line : Pas de bordure (c'est deja une ligne)
            Line={none=self.enum.none},

            -- Fieldset : Bordure double pour conteneurs (standard UI)
            Fieldset={double=self.enum.double, single=self.enum.single, dashed=self.enum.dashed}
        },-- Combinaisons UX par type (1ere = valeur par defaut pour .initial)
    },
   
    field_border_style={
        enum=OBJECTS_DEFINITIONS.field_avail_border_style.enum,
        default={
    ...
    field_title_fill_char={
        ...
        default={
            Field ={space=self.enum.space, underscore=self.enum.underscore, asterisk=self.enum.asterisk, dash=self.enum.dash},
            Literal ={space=self.enum.space, underscore=self.enum.underscore, asterisk=self.enum.asterisk, dash=self.enum.dash},
            ProtectedLiteral ={space=self.enum.space, underscore=self.enum.underscore, asterisk=self.enum.asterisk, dash=self.enum.dash},
            BooleanField ={space=self.enum.space, asterisk=self.enum.asterisk, dash=self.enum.dash},
            Image ={space=self.enum.space, underscore=self.enum.underscore, asterisk=self.enum.asterisk, dash=self.enum.dash},
            Line ={space=self.enum.space, underscore=self.enum.underscore, asterisk=self.enum.asterisk, dash=self.enum.dash},
            Fieldset ={space=self.enum.space, underscore=self.enum.underscore, asterisk=self.enum.asterisk, dash=self.enum.dash},
        },
        initial = nil,
        edited = nil
    },
    ...
    field_avail_vertical_align={
        ...
        default={
            Field = {top=self.enum.top, middle=self.enum.middle, bottom=self.enum.bottom},
            Literal = {top=self.enum.top},
            ProtectedLiteral = {top=self.enum.top},
            BooleanField = {top=self.enum.top, middle=self.enum.middle, bottom=self.enum.bottom},
            Image = {top=self.enum.top},
            Line = {top=self.enum.top},
            Fieldset = {top=self.enum.top}
        },
        initial=nil,
        edited=nil
    },
    ...
    field_vertical_align={
        enum=field_avail_vertical_align.enum,
        default={
            Field = field_avail_vertical_align.default.Field,
            Literal = field_avail_vertical_align.default.Literal,
            ProtectedLiteral = field_avail_vertical_align.default.ProtectedLiteral,
            BooleanField = field_avail_vertical_align.default.BooleanField,
            Image = field_avail_vertical_align.default.Image,
            Line = field_avail_vertical_align.default.Line,
            Fieldset = field_avail_vertical_align.default.Fieldset
        },
        initial=nil,
        edited=nil
    },
    ...
    field_vertical_margin={
        ...
        default={
            Field = self.enum.none,
            Literal = self.enum.none,
            ProtectedLiteral = self.enum.none,
            BooleanField = self.enum.none,
            Image = self.enum.none,
            Line = self.enum.none,
            Fieldset = self.enum.none
        },
        initial = self.enum.none,
        edited = self.enum.none
    },
    ...
    field_required_marker={
        default={
            Field = field_avail_required_marker.default.Field,
            Literal = field_avail_required_marker.default.Literal,
            ProtectedLiteral = field_avail_required_marker.default.ProtectedLiteral,
            BooleanField = field_avail_required_marker.default.BooleanField,
            Image = field_avail_required_marker.default.Image,
            Line = field_avail_required_marker.default.Line,
            Fieldset = field_avail_required_marker.default.Fieldset
        },
    },
    ...
    field_error_marker={
        default={
            Field = field_avail_error_marker.default.Field,
            Literal = field_avail_error_marker.default.Literal,
            ProtectedLiteral = field_avail_error_marker.default.ProtectedLiteral,
            BooleanField = field_avail_error_marker.default.BooleanField,
            Image = field_avail_error_marker.default.Image,
            Line = field_avail_error_marker.default.Line,
            Fieldset = field_avail_error_marker.default.Fieldset
        },
        initial=nil,
        edited=nil
    },
    ...
    field_title_suffix={
        default={
            Field =  {enabled=false,required = OBJECTS_DEFINITIONS.field_required_marker.default.Field, errors=OBJECTS_DEFINITIONS.field_error_marker.default.Field, none = ""},
            Literal =  {enabled=false,required = OBJECTS_DEFINITIONS.field_required_marker.default.Literal, errors=OBJECTS_DEFINITIONS.field_error_marker.default.Literal, none = ""},
            ProtectedLiteral =  {enabled=false,required = OBJECTS_DEFINITIONS.field_required_marker.default.ProtectedLiteral, errors=OBJECTS_DEFINITIONS.field_error_marker.default.ProtectedLiteral, none = ""},
            BooleanField =  {enabled=false,required = OBJECTS_DEFINITIONS.field_required_marker.default.BooleanField, errors=OBJECTS_DEFINITIONS.field_error_marker.default.BooleanField, none = ""},
            Image =  {enabled=false,required = OBJECTS_DEFINITIONS.field_required_marker.default.Image, errors=OBJECTS_DEFINITIONS.field_error_marker.default.Image, none = ""},
            Line =  {enabled=false,required = OBJECTS_DEFINITIONS.field_required_marker.default.Line, errors=OBJECTS_DEFINITIONS.field_error_marker.default.Line, none = ""},
            Fieldset =  {enabled=false,required = OBJECTS_DEFINITIONS.field_required_marker.default.Fieldset, errors=OBJECTS_DEFINITIONS.field_error_marker.default.Fieldset, none = ""}
        },
        initial = nil,
        edited = nil
    },
    ...
    field_title_prefix={
        default={
            Field =  {enabled=false,required = field_required_marker.default.Field, errors=field_error_marker.default.Field, none = ""},
            Literal =  {enabled=false,required = field_required_marker.default.Literal, errors=field_error_marker.default.Literal, none = ""},
            ProtectedLiteral =  {enabled=false,required = field_required_marker.default.ProtectedLiteral, errors=field_error_marker.default.ProtectedLiteral, none = ""},
            BooleanField =  {enabled=false,required = field_required_marker.default.BooleanField, errors=field_error_marker.default.BooleanField, none = ""},
            Image =  {enabled=false,required = field_required_marker.default.Image, errors=field_error_marker.default.Image, none = ""},
            Line =  {enabled=false,required = field_required_marker.default.Line, errors=field_error_marker.default.Line, none = ""},
            Fieldset =  {enabled=false,required = field_required_marker.default.Fieldset, errors=field_error_marker.default.Fieldset, none = ""}
        },
        initial = nil,
        edited = nil            
    },
    ...
    field_title_align={
        ...
        default={
            ...
            Field = self.enum.left,
            Literal = self.enum.left,
            ProtectedLiteral = self.enum.left,
            BooleanField = self.enum.left,
            Image = self.enum.left,
            -- Line: titre centre par defaut (ligne horizontale)
            Line = self.enum.center,
            -- Fieldset: titre centre par defaut (conteneur)
            Fieldset = self.enum.center
        },
        initial = nil,
        edited = nil
    },
